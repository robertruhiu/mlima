            ...
            <div style="margin-top: 3rem">
                <a-row>
                    <a-col :span="24" style="background-color: #1976D2;margin-bottom: 1rem">
                        <div style="padding: 2rem;" class='center'>
                            <h2 style="text-align: center;color: white">Privacy Policy</h2>
                ...
                <a-row style="margin-bottom: 1rem">
                    <a-col :span="24" style="padding-left: 25%;padding-right: 25%;padding-bottom: 5%">
                        ...
                        <p>CodeLn Technologies Limited ("us", "we", or "our") operates the www.codeln.com website (the
                            "Service").</p>
                        ...
                        <p>We use your data to provide and improve the Service. By using the Service, you agree to the
                            ...
                            Terms and Conditions, accessible from www.codeLn.com</p>
                        ...
                        <p>CodeLn Technologies Limited uses the collected data for various purposes:</p>
                        <ul>
                        ...
                        <p>CodeLn Technologies Limited will take all steps reasonably necessary to ensure that your data
                        ...
                        <p>CodeLn Technologies Limited may disclose your Personal Data in the good faith belief that
                            such action is necessary to:</p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of CodeLn Technologies Limited</li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>For more information on what type of information Mixpanel collects, please visit the
                                    Terms of Use page of Mixpanel: <a href="https://mixpanel.com/terms/">https://mixpanel.com/terms/</a>
                                </p>
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>By email: info@codeLn.com</li>
